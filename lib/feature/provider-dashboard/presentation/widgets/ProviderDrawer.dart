      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          _buildDrawerItem(
            ...
            icon: Icons.kitchen,
            text: 'Mis Equipos',
            // Esta ruta ya existe en tu main.dart
            routeName: '/provider_equipment_detail',
          ),
          _buildDrawerItem(
            context,
            icon: Icons.people,
          ...
          _buildDrawerItem(
            ...
            text: 'Técnicos',
            // Esta ruta también apunta a la misma pantalla
            routeName: '/provider_clients_technicians',
          ),
          const Divider(),
          _buildDrawerItem(
            ...
            // TODO: Añadir lógica real de logout (limpiar provider/token)
          ),
        ],
      ),
    );
